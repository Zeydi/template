                                    ...
                                    <div className="item-img-info"><Link to={'/product-details'}
                                        ...
                                        <div className="item-box-hover">
                                            <div className="box-inner">
                                                <div className="product-detail-bnt"><Link
                                                    className="button detail-bnt"><span>Quick View</span></Link></div>
                                                <div className="actions"><span className="add-to-links"><Link href="#"
                                                    className="link-wishlist" title="Add to Wishlist"><span>Add
                                                                    to Wishlist</span></Link> <Link href="#"
                                        ...
                                        <div className="item-content">
                                            ...
                                            <div className="item-price">
                                                <div className="price-box"><span className="regular-price"><span
                                                    className="price">$125.00</span> </span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
